...
<head>
    ...
    <style>
        .bg-login-image {
            background-image: url('{{ asset('images/log.jpeg') }}'); /* Remplacez par le chemin de votre image */
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('auth.store') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Entrez votre adresse email...">
                                        </div>
                                        <div class="form-group">
